...
const HomePage = () => {
  ...
  return (
    <div className="h-screen w-screen bg-gradient-to-r from-blue-900 to-indigo-900 text-white py-12 px-6">
      <div className="max-w-6xl mx-auto bg-white bg-opacity-10 p-8 rounded-lg shadow-2xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {jewelryList.map((item) => (
            <div
              key={item._id}
              className="bg-white bg-opacity-90 shadow-lg rounded-lg overflow-hidden transition-transform transform hover:scale-105"
            >
              <img
